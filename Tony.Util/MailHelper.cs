   ...
   public class MailHelper
    {
        ...
        /// 邮件服务器地址
        /// </summary>
        private static readonly string MailServer = Config.GetValue("MailHost");
        /// <summary>
        /// 用户名
        /// </summary>
        private static readonly string MailUserName = Config.GetValue("MailUserName");
        /// <summary>
        /// 密码
        /// </summary>
        private static readonly string MailPassword = Config.GetValue("MailPassword");
        /// <summary>
        /// 名称
        /// </summary>
        private static readonly string MailName = Config.GetValue("MailName");
        ...
        public static bool Send(string to, string subject, string body, string encoding = "UTF-8",
            bool isBodyHtml = true, bool enableSsl = false)
        {
            try
            {
                ...
                var smtp = new SmtpClient(MailServer,25);
        ...
        public static void SendByThread(string to, string title, string body, int port = 25)
        {
            new Thread(new ThreadStart(delegate ()
            {
                try
                {
                    ...
                    //消息发送人
                    objMailMessage.From = new MailAddress(MailUserName, "提醒", Encoding.UTF8);
                    //收件人

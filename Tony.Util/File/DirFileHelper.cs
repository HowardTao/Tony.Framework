   ...
   public class DirFileHelper
    {
        ...
        {
            if (!IsExistDirectory(dirPath)) throw new FileNotFoundException();
        ...
        public static bool IsEmptyDirectory(string directoryPath)
        {
            try
            {
                ...
                var dirNames = GetDirectories(directoryPath);
        ...
        #region 检测指定目录中是否存在指定的文件,若要搜索子目录请使用重载方法.
        /// <summary>
        ...
        /// 删除目录
        /// </summary>
        /// <param name="dir">要删除的目录路径包括目录名</param>

   ...
   public sealed partial class Str
    {
        ...
        private static string ResolvePinYin(char text)
        {
            ...
            var pinYin = ResolvePinYinByCode(unicode);
            return !string.IsNullOrWhiteSpace(pinYin) ? pinYin : ResolvePinYinByFile(text.ToString());
        }
        ...
        private static string ResolvePinYinByFile(string text)
        {
            ...
            return index < 0 ? string.Empty : Const.ChinesePinYin.Substring(index + 1, 1);
        }
        #endregion

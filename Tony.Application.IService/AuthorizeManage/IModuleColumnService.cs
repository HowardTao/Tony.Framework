...
namespace Tony.Application.IService.AuthorizeManage
{
    ...
    public interface IModuleColumnService
    {
        ...
        IEnumerable<ModuleColumnEntity> GetPageList(Pagination pagination, string queryJson);
        /// <summary>
        /// 获取列表
        /// </summary>
        /// <returns>返回列表</returns>
        IEnumerable<ModuleColumnEntity> GetList();
        /// <summary>
        /// 获取实体
        /// </summary>
        ...
        /// <returns></returns>
        void SaveForm(string keyValue, ModuleColumnEntity entity);
        #endregion
    }
}

...
namespace Tony.Application.IService.AuthorizeManage
{
    ...
    public interface IModuleButtonService
    {
        ...
        IEnumerable<ModuleButtonEntity> GetPageList(Pagination pagination, string queryJson);
        /// <summary>
        /// 获取列表
        /// </summary>
        /// <returns>返回列表</returns>
        IEnumerable<ModuleButtonEntity> GetList();
        /// <summary>
        /// 获取实体
        /// </summary>
        ...
        /// <returns></returns>
        void SaveForm(string keyValue, ModuleButtonEntity entity);
        #endregion
    }
}
